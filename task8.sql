...
CREATE PROCEDURE AddNewProduct(IN pname VARCHAR(100), IN pdesc TEXT, IN pprice DECIMAL(10,2), IN pqty INT)
BEGIN
    INSERT INTO Products(name, description, price, stock_quantity)
    VALUES (pname, pdesc, pprice, pqty);
END //

CREATE FUNCTION GetTotalSpentByCustomer(cid INT) RETURNS DECIMAL(10,2)
DETERMINISTIC
BEGIN
...
CALL AddNewProduct('Keyboard', 'Mechanical, backlit', 2200.00, 25);

SELECT GetTotalSpentByCustomer(1) AS total_spent;
